import { ChevronDown, ScanBarcode, X } from 'lucide-preact'
...
export function EditCardForm({ initialCard, onSave, onClose }: EditCardFormProps) {
  ...
  const [qrCodeFormat, setQRCodeFormat] = useState<QRCodeFormat>(
    initialCard.qrCodeFormat ?? QRCodeFormat.QR_CODE,
  )
